...
Latest image [on Docker Hub](https://hub.docker.com/r/dispatchframework/python3-base/): `dispatchframework/python3-base:0.0.7`
...
```bash
$ dispatch create base-image python3-base dispatchframework/python3-base:0.0.7
```
